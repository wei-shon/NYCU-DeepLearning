...
def train(args, env, agent, writer):
    ...
    # store the reward to plot picture
    reward_list = []
    ewma_reward_list = []
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                writer.add_scalar('Train/Ewma Reward', ewma_reward,
                                  total_steps)
                # writer.write(f'================{total_steps}================\n')
                # writer.write(f'Train/Episode Reward : {total_reward}\n')
                # writer.write(f'Train/Ewma Reward : {ewma_reward}\n')
                print(
    ...
    for n_episode, seed in enumerate(seeds):
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                # writer.write(f'================{n_episode}================\n')
                # writer.write(f'Test/Episode Reward : {total_reward}\n')
                print(
                    f'episode: {n_episode}: {total_reward:.2f}'
                )
...
def main():
    ...
    parser.add_argument('-m', '--model', default='./weights/ddpg.pth')
    ...
    # writer = open('./{}/train_record.txt'.format(args.logdir), 'a')
