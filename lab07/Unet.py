...
class UNet(nn.Module):
    ...
    def forward(self, input_tensor, time , cond):
        time_encoded = self.positional_encoding(time)
        cond_expand = self.cond_upup(cond)

        # print("time_encoded" , time_encoded.shape)
        # print("cond_expand" , cond_expand.shape)
        time_encoded+=cond_expand
